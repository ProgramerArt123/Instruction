#include "Define.h"
#include "x86/mnemonic/classic/integer/64/DataTransmitted.h"
...
namespace x86
{
	namespace size64
	{
		DataTransmitted::DataTransmitted(const x86::immediate::size64::Immediate64 &source, const x86::reg::classic::general::operation::size64::Operation64 &destination)
			: AbstractInstruction(x86::mnemonic::classic::integer::size64::data_transmitted::Transmitted_8__16__32__64(), source, destination)
		{
		}
