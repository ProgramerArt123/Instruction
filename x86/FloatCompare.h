...
class FloatCompare {
public:
	const char *Compare_ST__Value_4__8_C1_C0_C2_C3()const;
	const char *Compare_ST_Value_C1()const;
	const char *Compare_Pop_Stack_ST_Value_C1()const;
	const char *Compare_Integer_2__4_C1_C0_C2_C3()const;
	const char *Compare_Pop_Stack_Integer_2__4_C1_C0_C2_C3()const;
