...
//	}
	...
	{
		out << x86::BitsMoveLeftSign(x86::immediate::ImmediateSigned8(1), AL) << std::endl;
	}
	{
		out << x86::BitsMoveLeftSign(x86::immediate::ImmediateUnSigned8(1), AX) << std::endl;
	}
	{
		out << x86::BitsMoveLeftSign(x86::immediate::ImmediateUnSigned8(1), EAX) << std::endl;
	}
	
	{
		out << x86::BitsMoveRight(x86::immediate::ImmediateSigned8(1), AL) << std::endl;
	}
	{
		out << x86::BitsMoveRight(x86::immediate::ImmediateUnSigned8(1), AX) << std::endl;
	}
	{
	...
	{
		out << x86::BitsRollLeft(x86::immediate::ImmediateSigned8(1), AL) << std::endl;
	}
	{
		out << x86::BitsRollLeft(x86::immediate::ImmediateUnSigned8(1), AX) << std::endl;
	}
	{
		out << x86::BitsRollLeft(x86::immediate::ImmediateUnSigned8(1), EAX) << std::endl;
	}
	
	{
		out << x86::BitsRollRight(x86::immediate::ImmediateSigned8(1), AL) << std::endl;
	}
	{
		out << x86::BitsRollRight(x86::immediate::ImmediateUnSigned8(1), AX) << std::endl;
	}
	{
		out << x86::BitsRollRight(x86::immediate::ImmediateUnSigned8(1), EAX) << std::endl;
	}
	
	{
		out << x86::BitsCarrayRollLeft(x86::immediate::ImmediateSigned8(1), AL) << std::endl;
	}
	{
		out << x86::BitsCarrayRollLeft(x86::immediate::ImmediateUnSigned8(1), AX) << std::endl;
	}
	{
		out << x86::BitsCarrayRollLeft(x86::immediate::ImmediateUnSigned8(1), EAX) << std::endl;
	}
	
	{
		out << x86::BitsCarrayRollRight(x86::immediate::ImmediateSigned8(1), AL) << std::endl;
	}
	{
		out << x86::BitsCarrayRollRight(x86::immediate::ImmediateUnSigned8(1), AX) << std::endl;
	}
	{
		out << x86::BitsCarrayRollRight(x86::immediate::ImmediateUnSigned8(1), EAX) << std::endl;
	}
